...
class Widget_KEA_Radar_Chart extends Widget_Base {

	public function get_name() {
		return 'cj-radar_chart';
	}

	public function get_title() {
		return "[KS] " . esc_html__( 'Radar Chart', 'keystone-elements-addons' );
	}
    ...
    public function get_script_depends() {
		return [ 'cj-lib-chart', 'cj-radar_chart' ];
	}
	...
	protected function register_controls() {
		...
		// section start
  		$this->start_controls_section(
  			'radar_chart_content',
  			[
  				'label' => esc_html__( 'Radar Chart', 'keystone-elements-addons' ),
        ...
        $repeater->add_control(
			'item_point_color',
			[
				'label' => esc_html__( 'Point Color', 'keystone-elements-addons' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => [
					...
					[
						'item_label' => esc_html__( 'Dataset 3', 'keystone-elements-addons' ),
						'item_data' => '20, 45, 25'
					],
				],
		...
		$this->add_control(
			'gridline_circular',
			[
				'label' => esc_html__( 'Circular', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'true' => [
						'title' => esc_html__( 'Yes', 'keystone-elements-addons' ),
