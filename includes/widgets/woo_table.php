...
class Widget_KEA_Woo_Table extends Widget_Base {
	...
	public function get_title() {
		return "[KS] " . esc_html__( 'WooCommerce Table', 'keystone-elements-addons' );
	}
    ...
    public function get_style_depends(){
		return [ 'cj-lib-table','elementor-icons-fa-solid','cj-table' ];
	}
    
    public function get_script_depends() {
		return [ 'cj-lib-table', 'cj-woo_table' ];
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			'column_name',
			[
				'label' => esc_html__( 'Column Name', 'keystone-elements-addons' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'Column Name', 'keystone-elements-addons' )
			]
        );
        ...
        $repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'name'  => esc_html__( 'Product Name', 'keystone-elements-addons' ),
                    'price'  => esc_html__( 'Price', 'keystone-elements-addons' ),
                    'sku'  => esc_html__( 'SKU', 'keystone-elements-addons' ),
                    'stock_quantity'  => esc_html__( 'Stock Quantity', 'keystone-elements-addons' ),
                    'stock'  => esc_html__( 'Stock Status', 'keystone-elements-addons' ),
                    'add_to_cart'  => esc_html__( 'Add to Cart Button', 'keystone-elements-addons' )
				],
			]
        );
        ...
        $this->add_control(
			...
			[
				...
				'default' => [
					[
                        'column_name' => esc_html__( 'Thumbnail', 'keystone-elements-addons' ),
                        'column_source' => 'thumbnail',
                        'column_align' => 'left'
                    ],
                    [
                        'column_name' => esc_html__( 'Product Name', 'keystone-elements-addons' ),
                        'column_source' => 'name',
                        'column_align' => 'left'
                    ],
                    [
                        'column_name' => esc_html__( 'Price', 'keystone-elements-addons' ),
                        'column_source' => 'price',
                        'column_align' => 'left'
                    ],
                    [
                        'column_name' => esc_html__( 'Add to Cart', 'keystone-elements-addons' ),
        ...
        $this->add_control(
			'table_paging',
			[
				'label' => esc_html__( 'Paging', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'keystone-elements-addons' ),
				'label_off' => esc_html__( 'No', 'keystone-elements-addons' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
            'table_page_length',
            [
                'label' => esc_html__( 'Page Length', 'keystone-elements-addons' ),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'default' => 20
            ]
        );
        ...
        $this->add_control(
			'table_searching',
			[
				'label' => esc_html__( 'Searching', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'keystone-elements-addons' ),
				'label_off' => esc_html__( 'No', 'keystone-elements-addons' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'table_ordering',
			[
				'label' => esc_html__( 'Ordering', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'keystone-elements-addons' ),
				'label_off' => esc_html__( 'No', 'keystone-elements-addons' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'table_buttons',
			[
				'label' => esc_html__( 'Table Buttons', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'keystone-elements-addons' ),
				'label_off' => esc_html__( 'No', 'keystone-elements-addons' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			'table_spacing',
			[
				'label' => esc_html__( 'Inner Spacing (px)', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 100,
				'step' => 1,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Top-Bottom Spacing (px)', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 100,
				'step' => 1,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Table Header', 'keystone-elements-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
        );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Sorting Icon Align', 'keystone-elements-addons' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'keystone-elements-addons' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Minumum Width', 'keystone-elements-addons' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Image Maximum Width', 'keystone-elements-addons' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'vw', 'rem' ],
				'range' => [
					'vw' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Table Body', 'keystone-elements-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
        );
        ...
        $this->start_controls_tab(
			'table_body_odd',
			[
				'label' => esc_html__( 'Odd', 'keystone-elements-addons'),
			]
		);
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#2e5d9f',
                'selectors' => [
                    '{{WRAPPER}} table.dataTable tbody tr.odd a.kea-table-link' => 'color: {{VALUE}};'
				]
			]
        );
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#2e5d9f',
                'selectors' => [
                    '{{WRAPPER}} table.dataTable tbody tr.odd a.kea-table-link:hover' => 'color: {{VALUE}};'
				]
			]
        );
        ...
        $this->add_control(
			'table_body_odd_bg',
			[
				'label' => esc_html__( 'Row Background Color', 'keystone-elements-addons' ),
				'type' => Controls_Manager::COLOR,
                'default' => '#f9f9f9',
                'selectors' => [
		...
		$this->start_controls_tab(
			'table_body_even',
			[
				'label' => esc_html__( 'Even', 'keystone-elements-addons'),
			]
		);
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#2e5d9f',
                'selectors' => [
                    '{{WRAPPER}} table.dataTable tbody tr.even a.kea-table-link' => 'color: {{VALUE}};'
				]
			]
        );
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#2e5d9f',
                'selectors' => [
                    '{{WRAPPER}} table.dataTable tbody tr.even a.kea-table-link:hover' => 'color: {{VALUE}};'
				]
			]
        );
        ...
        $this->start_controls_section(
			'section_button',
			[
				'label' => esc_html__( 'Add To Cart Button', 'keystone-elements-addons' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
        );
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Search Box', 'keystone-elements-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'table_searching' => 'yes'
                ],
                ...
                <tbody>
                    ...
                    foreach ( $settings['column_list'] as $item ) {
                        if ($item['column_source'] == 'thumbnail') {
                            ...
                            echo '<td style="text-align:' . $item['column_align'] . ';"><a class="kea-table-link" href="' . get_the_permalink() . '">' . get_the_title() . '</a></td>';
                            ...
                            $stock = str_replace( array('instock','outofstock'), array(esc_html__( 'In Stock', 'keystone-elements-addons' ),esc_html__( 'Out Of Stock', 'keystone-elements-addons' )), $stock );
...
Plugin::instance()->widgets_manager->register( new Widget_KEA_Woo_Table() );