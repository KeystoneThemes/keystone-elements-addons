...
class Widget_KEA_Image_Compare extends Widget_Base {

	public function get_name() {
		return 'cj-image_compare';
	}

	public function get_title() {
		return "[KS] " . esc_html__( 'Image Compare', 'keystone-elements-addons' );
	}
	...
	public function get_script_depends() {
		return [ 'cj-image_compare', 'cj-afe-imagesloaded' ];
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'orientation',
			[
				'label' => esc_html__( 'Orientation', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'horizontal' => [
						'title' => esc_html__( 'Horizontal', 'keystone-elements-addons' ),
						'icon' => 'fas fa-arrows-alt-h',
					],
					'vertical' => [
						'title' => esc_html__( 'Vertical', 'keystone-elements-addons' ),
        ...
        $this->add_control(
			'offset',
			[
                'label' => esc_html__( 'Default Offset', 'keystone-elements-addons' ),
                'description' => esc_html__( 'How much of the before image is visible when the page loads.', 'keystone-elements-addons' ),
        ...
        $this->add_control(
			'overlay',
			[
				'label' => esc_html__( 'Hide Overlay', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'true' => [
				...
				'default' => 'false',
				'description' => esc_html__( 'Do not show the overlay with before and after.', 'keystone-elements-addons' ),
				'toggle' => false,
			]
        );
        ...
        $this->add_control(
			'move_overlay',
			[
				'label' => esc_html__( 'Move Slider on Hover', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'true' => [
						'title' => esc_html__( 'Yes', 'keystone-elements-addons' ),
                ...
                'default' => 'false',
                'description' => esc_html__( 'Slider works only on front-end.', 'keystone-elements-addons' ),
				'toggle' => false,
			]
		);
		...
		$this->start_controls_section(
			'handle_bar_section',
			[
				'label' => esc_html__( 'Handle Bar', 'keystone-elements-addons' ),
        ...
        $this->add_responsive_control(
			'handle_bar_size',
			[
				'label' => esc_html__( 'Bar Size (px)', 'keystone-elements-addons' ),
        ...
        $this->start_controls_section(
			'handle_btn_section',
			[
				'label' => esc_html__( 'Handle Button', 'keystone-elements-addons' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Border Size (px)', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Before Label', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
        );
        ...
        $this->add_control(
			'after_label_heading',
			[
				'label' => esc_html__( 'After Label', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
        );
	...
	protected function render() {
        ...
        if (empty($before_label)) {
            $before_label = esc_html__( 'Before', 'keystone-elements-addons' );
        }
        if (empty($after_label)) {
            $after_label = esc_html__( 'After', 'keystone-elements-addons' );
        }
        ?>
        <div class="cj-image-compare">
...
Plugin::instance()->widgets_manager->register( new Widget_KEA_Image_Compare() );