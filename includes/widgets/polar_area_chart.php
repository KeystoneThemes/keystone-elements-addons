...
class Widget_KEA_Polar_Area_Chart extends Widget_Base {

	public function get_name() {
		return 'cj-polar_area_chart';
	}

	public function get_title() {
		return "[KS] " . esc_html__( 'Polar Area Chart', 'keystone-elements-addons' );
	}
    ...
    public function get_script_depends() {
		return [ 'cj-lib-chart', 'cj-polar_area_chart' ];
	}
	...
	protected function register_controls() {
		...
		// section start
  		$this->start_controls_section(
  			...
  			[
  				'label' => esc_html__( 'Polar Area Chart', 'keystone-elements-addons' ),
		...
		$this->add_control(
			'gridline',
			[
				'label' => esc_html__( 'Display Gridlines', 'keystone-elements-addons' ),
