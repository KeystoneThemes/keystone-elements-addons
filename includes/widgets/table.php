...
class Widget_KEA_Table extends Widget_Base {
	...
	public function get_title() {
		return "[KS] " . esc_html__( 'Table', 'keystone-elements-addons' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'options' => [
                    ...
                    'csv' => esc_html__( 'CSV', 'keystone-elements-addons' )
				],
                'default' => 'custom'
			]
        );
        ...
        $this->add_control(
			'csv_link',
			[
				'label' => esc_html__( 'Select CSV File', 'keystone-elements-addons' ),
				'type'	=> 'kea-file-select',
				'placeholder' => esc_html__( 'URL to File', 'keystone-elements-addons' ),
                'default' => KEA_PLUGINS_URL . 'assets/img/sample.csv',
                'condition' => [
                    'table_source' => 'csv'
                ],
			]
        ...
        $repeater->add_control(
			...
			[
				'label' => esc_html__( 'Style This Column', 'keystone-elements-addons' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => [
					[
						'table_header_label' => esc_html__( 'Name', 'keystone-elements-addons' )
					],
					[
                        'table_header_label' => esc_html__( 'Position', 'keystone-elements-addons' )
                    ],
                    [
                        'table_header_label' => esc_html__( 'Office', 'keystone-elements-addons' )
                    ],
                    [
                        'table_header_label' => esc_html__( 'Age', 'keystone-elements-addons' )
                    ],
                    [
                        'table_header_label' => esc_html__( 'Start Date', 'keystone-elements-addons' )
                    ],
                    [
                        'table_header_label' => esc_html__( 'Salary', 'keystone-elements-addons' )
					],
				],
        ...
        $repeater2->add_control(
			'table_body_action',
			[
                'label' => esc_html__( 'Action', 'keystone-elements-addons' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'Cell' => esc_html__( 'Add New Cell', 'keystone-elements-addons' ),
                    'Start Row' => esc_html__( 'Start New Row', 'keystone-elements-addons' )
				],
                'default' => 'Cell'
			]
        );
			...
			[
				...
				'default' => [
					[
						...
						'table_body_label' => esc_html__( 'Sample Content...', 'keystone-elements-addons' )
					],
					[
                        'table_body_action' => 'Cell',
                        'table_body_label' => esc_html__( 'Sample Content...', 'keystone-elements-addons' )
        ...
        $this->add_control(
			'table_buttons',
			[
				'label' => esc_html__( 'Buttons', 'keystone-elements-addons' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'keystone-elements-addons' ),
				'label_off' => esc_html__( 'No', 'keystone-elements-addons' ),
				'return_value' => 'yes',
...
Plugin::instance()->widgets_manager->register( new Widget_KEA_Table() );