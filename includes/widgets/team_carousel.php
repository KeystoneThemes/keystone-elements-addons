...
class Widget_KEA_Team_Carousel extends Widget_Base {

	public function get_name() {
		return 'cj-team_carousel';
	}

	public function get_title() {
		return "[KS] " . esc_html__( 'Team Carousel', 'keystone-elements-addons' );
	}
	...
	public function get_style_depends(){
		return [ 'cj-lib-slick','elementor-icons-fa-solid','cj-lib-animate','cj-lib-lightbox','cj-team_member','cj-lib-animate' ];
	}
    
    public function get_script_depends() {
		return [ 'cj-lib-slick','cj-lib-lightbox','cj-team_carousel' ];
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
			'section_carousel',
			[
				'label' => esc_html__( 'Carousel', 'keystone-elements-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-prev' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .cj-team-carousel .slick-next' => 'color: {{VALUE}};'
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'default' => 'rgba(0,0,0,0)',
				'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-prev' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .cj-team-carousel .slick-next' => 'background-color: {{VALUE}};'
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-prev:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .cj-team-carousel .slick-next:hover' => 'color: {{VALUE}};'
				],
			]
        );
        ...
        $this->add_control(
			...
			[
				...
				'default' => 'rgba(0,0,0,0)',
				'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-prev:hover' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .cj-team-carousel .slick-next:hover' => 'background-color: {{VALUE}};'
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 30,
                'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-prev' => 'font-size: {{VALUE}}px;',
                    '{{WRAPPER}} .cj-team-carousel .slick-next' => 'font-size: {{VALUE}}px;',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 60,
                'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-prev' => 'height: {{VALUE}}px;width: {{VALUE}}px;line-height: {{VALUE}}px;',
                    '{{WRAPPER}} .cj-team-carousel .slick-next' => 'height: {{VALUE}}px;width: {{VALUE}}px;line-height: {{VALUE}}px;'
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'size_units' => [ 'px', '%', 'rem' ],
				'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-next' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};border-bottom-right-radius: {{BOTTOM}}{{UNIT}};border-bottom-left-radius: {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .cj-team-carousel .slick-prev' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};border-bottom-right-radius: {{BOTTOM}}{{UNIT}};border-bottom-left-radius: {{LEFT}}{{UNIT}};'
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 0,
                'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-next' => 'right: {{VALUE}}px;',
                    '{{WRAPPER}} .cj-team-carousel .slick-prev' => 'left: {{VALUE}}px;'
				],
			]
        );
        ...
        $this->add_control(
			...
			[
				...
				'default' => '#000000',
				'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-dots li button:before' => 'color: {{VALUE}};'
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 20,
                'selectors' => [
					'{{WRAPPER}} .cj-team-carousel .slick-dots li button:before' => 'font-size: {{VALUE}}px;line-height: {{VALUE}}px;width: {{VALUE}}px;height: {{VALUE}}px;',
                    '{{WRAPPER}} .cj-team-carousel .slick-dots li button' => 'width: {{VALUE}}px;height: {{VALUE}}px;',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 2,
                'selectors' => [
                    '{{WRAPPER}} .cj-team-carousel .slick-dots li' => 'margin-left: {{VALUE}}px !important;margin-right: {{VALUE}}px !important;',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => 20,
                'selectors' => [
                    '{{WRAPPER}} .cj-team-carousel .slick-dots' => 'bottom: {{VALUE}}px;',
				],
			]
		);
...
Plugin::instance()->widgets_manager->register( new Widget_KEA_Team_Carousel() );