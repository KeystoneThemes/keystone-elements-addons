...
class CMB2_Utils {
	...
	/**
	 * Takes a php gmdate() format string and returns a string formatted to suit for the date/time pickers
	 * It will work only with the following subset of gmdate() options:
	 *
